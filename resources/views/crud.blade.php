...
<html>
    ...
    <body>
        ...
        while($pesertavaksin = mysqli_fetch_array($query)){
            ...
            <td>
                <h1><a class="ubah" href="/update?id=<?php echo $pesertavaksin["id"]; ?>"><button width=50px>Ubah</button></a></h1>
                <h1><a class="hapus" href="/hapus?id=<?php echo $pesertavaksin["id"]; ?>"><button width=50px>Hapus</button></a></h1>
            <td>
            </tr>
            <?php
            }
    ...
    <footer>
        <a href="/form"><button type="button" class="btn btn-dark">Kembali</button></a>
    </footer>
</html>